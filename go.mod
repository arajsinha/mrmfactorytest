...
// This block is a master override that forces all Kubernetes libraries
// used by any transitive dependency to conform to this specific, compatible version.
replace (
...
// The 'go mod tidy' command will automatically clean up and manage this section.
require (
	github.com/beorn7/perks v1.0.1 // indirect
// ... other indirect dependencies will be added/updated here by 'go mod tidy'
)

require github.com/hashicorp/vault/api v1.21.0
